...
CREATE TABLE `movies` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_movie-status_idx` (`status`),
  CONSTRAINT `fk_movie-status` FOREIGN KEY (`status`) REFERENCES `movie_status` (`id`)
...
CREATE TABLE `schedules` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_schedule-movies_idx` (`movie_id`),
  KEY `fk_schedule-location_idx` (`location_id`),
  KEY `fk_time-show_idx` (`time_id`),
